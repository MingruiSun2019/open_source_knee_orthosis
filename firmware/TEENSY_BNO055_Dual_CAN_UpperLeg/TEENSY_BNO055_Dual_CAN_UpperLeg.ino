...
#define CAN_ID_IMU1_ACCL 0x262
#define CAN_ID_IMU1_GYRO 0x263
#define CAN_ID_IMU1_OREN 0x264
#define CAN_ID_IMU2_ACCL 0x265
#define CAN_ID_IMU2_GYRO 0x266
#define CAN_ID_IMU2_OREN 0x267
...
void loop(void)
{
  ...
  for (int id = 0; id < numIMU; id++)
  {
    ...
    if (id == 0)
    {
      ...
      msg_oren[3] = range_mapping(quat.z(), QUANT_RANGE, INT16_MAX);  
